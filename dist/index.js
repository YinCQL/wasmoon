(function (global, factory) {
    ...
    var Module = typeof initWasmModule != "undefined" ? initWasmModule : {};
    ...
    if (ENVIRONMENT_IS_NODE) {
     ...
     var require$1 = createRequire((typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('index.js', document.baseURI).href)));
     var fs = require$1("fs");
     var nodePath = require$1("path");
     if (ENVIRONMENT_IS_WORKER) {
      scriptDirectory = nodePath.dirname(scriptDirectory) + "/";
     } else {
      scriptDirectory = require$1("url").fileURLToPath(new URL("./", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('index.js', document.baseURI).href))));
     }
    ...
    if (Module["locateFile"]) {
     wasmBinaryFile = "glue.wasm";
     if (!isDataURI(wasmBinaryFile)) {
      wasmBinaryFile = locateFile(wasmBinaryFile);
     }
    } else {
     wasmBinaryFile = new URL("glue.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('index.js', document.baseURI).href))).href;
    }
    ...
    function _system(command) {
     if (ENVIRONMENT_IS_NODE) {
      ...
      var cp = require$1("child_process");
    ...
    Module["_lua_checkstack"] = createExportWrapper("lua_checkstack");

    Module["_lua_xmove"] = createExportWrapper("lua_xmove");

    Module["_lua_atpanic"] = createExportWrapper("lua_atpanic");

    Module["_lua_version"] = createExportWrapper("lua_version");

    Module["_lua_absindex"] = createExportWrapper("lua_absindex");

    Module["_lua_gettop"] = createExportWrapper("lua_gettop");

    Module["_lua_settop"] = createExportWrapper("lua_settop");

    Module["_lua_closeslot"] = createExportWrapper("lua_closeslot");

    Module["_lua_rotate"] = createExportWrapper("lua_rotate");

    Module["_lua_copy"] = createExportWrapper("lua_copy");

    Module["_lua_pushvalue"] = createExportWrapper("lua_pushvalue");

    Module["_lua_type"] = createExportWrapper("lua_type");

    Module["_lua_typename"] = createExportWrapper("lua_typename");

    Module["_lua_iscfunction"] = createExportWrapper("lua_iscfunction");

    Module["_lua_isinteger"] = createExportWrapper("lua_isinteger");

    Module["_lua_isnumber"] = createExportWrapper("lua_isnumber");

    Module["_lua_isstring"] = createExportWrapper("lua_isstring");

    Module["_lua_isuserdata"] = createExportWrapper("lua_isuserdata");

    Module["_lua_rawequal"] = createExportWrapper("lua_rawequal");

    Module["_lua_arith"] = createExportWrapper("lua_arith");

    Module["_lua_compare"] = createExportWrapper("lua_compare");

    Module["_lua_stringtonumber"] = createExportWrapper("lua_stringtonumber");

    Module["_lua_tonumberx"] = createExportWrapper("lua_tonumberx");

    Module["_lua_tointegerx"] = createExportWrapper("lua_tointegerx");

    Module["_lua_toboolean"] = createExportWrapper("lua_toboolean");

    Module["_lua_tolstring"] = createExportWrapper("lua_tolstring");

    Module["_lua_rawlen"] = createExportWrapper("lua_rawlen");

    Module["_lua_tocfunction"] = createExportWrapper("lua_tocfunction");

    Module["_lua_touserdata"] = createExportWrapper("lua_touserdata");

    Module["_lua_tothread"] = createExportWrapper("lua_tothread");

    Module["_lua_topointer"] = createExportWrapper("lua_topointer");

    Module["_lua_pushnil"] = createExportWrapper("lua_pushnil");

    Module["_lua_pushnumber"] = createExportWrapper("lua_pushnumber");

    Module["_lua_pushinteger"] = createExportWrapper("lua_pushinteger");

    Module["_lua_pushlstring"] = createExportWrapper("lua_pushlstring");

    Module["_lua_pushstring"] = createExportWrapper("lua_pushstring");

    Module["_lua_pushcclosure"] = createExportWrapper("lua_pushcclosure");

    Module["_lua_pushboolean"] = createExportWrapper("lua_pushboolean");

    Module["_lua_pushlightuserdata"] = createExportWrapper("lua_pushlightuserdata");

    Module["_lua_pushthread"] = createExportWrapper("lua_pushthread");

    Module["_lua_getglobal"] = createExportWrapper("lua_getglobal");

    Module["_lua_gettable"] = createExportWrapper("lua_gettable");

    Module["_lua_getfield"] = createExportWrapper("lua_getfield");

    Module["_lua_geti"] = createExportWrapper("lua_geti");

    Module["_lua_rawget"] = createExportWrapper("lua_rawget");

    Module["_lua_rawgeti"] = createExportWrapper("lua_rawgeti");

    Module["_lua_rawgetp"] = createExportWrapper("lua_rawgetp");

    Module["_lua_createtable"] = createExportWrapper("lua_createtable");

    Module["_lua_getmetatable"] = createExportWrapper("lua_getmetatable");

    Module["_lua_getiuservalue"] = createExportWrapper("lua_getiuservalue");

    Module["_lua_setglobal"] = createExportWrapper("lua_setglobal");

    Module["_lua_settable"] = createExportWrapper("lua_settable");

    Module["_lua_setfield"] = createExportWrapper("lua_setfield");

    Module["_lua_seti"] = createExportWrapper("lua_seti");

    Module["_lua_rawset"] = createExportWrapper("lua_rawset");

    Module["_lua_rawsetp"] = createExportWrapper("lua_rawsetp");

    Module["_lua_rawseti"] = createExportWrapper("lua_rawseti");

    Module["_lua_setmetatable"] = createExportWrapper("lua_setmetatable");

    Module["_lua_setiuservalue"] = createExportWrapper("lua_setiuservalue");

    Module["_lua_callk"] = createExportWrapper("lua_callk");

    Module["_lua_pcallk"] = createExportWrapper("lua_pcallk");

    Module["_lua_load"] = createExportWrapper("lua_load");

    Module["_lua_dump"] = createExportWrapper("lua_dump");

    Module["_lua_status"] = createExportWrapper("lua_status");

    Module["_lua_error"] = createExportWrapper("lua_error");

    Module["_lua_next"] = createExportWrapper("lua_next");

    Module["_lua_toclose"] = createExportWrapper("lua_toclose");

    Module["_lua_concat"] = createExportWrapper("lua_concat");

    Module["_lua_len"] = createExportWrapper("lua_len");

    Module["_lua_getallocf"] = createExportWrapper("lua_getallocf");

    Module["_lua_setallocf"] = createExportWrapper("lua_setallocf");

    Module["_lua_setwarnf"] = createExportWrapper("lua_setwarnf");

    Module["_lua_warning"] = createExportWrapper("lua_warning");

    Module["_lua_newuserdatauv"] = createExportWrapper("lua_newuserdatauv");

    Module["_lua_getupvalue"] = createExportWrapper("lua_getupvalue");

    Module["_lua_setupvalue"] = createExportWrapper("lua_setupvalue");

    Module["_lua_upvalueid"] = createExportWrapper("lua_upvalueid");

    Module["_lua_upvaluejoin"] = createExportWrapper("lua_upvaluejoin");

    Module["_luaL_traceback"] = createExportWrapper("luaL_traceback");

    Module["_luaL_buffinit"] = createExportWrapper("luaL_buffinit");

    Module["_luaL_addstring"] = createExportWrapper("luaL_addstring");

    Module["_luaL_prepbuffsize"] = createExportWrapper("luaL_prepbuffsize");

    Module["_lua_getstack"] = createExportWrapper("lua_getstack");

    Module["_luaL_addvalue"] = createExportWrapper("luaL_addvalue");

    Module["_lua_getinfo"] = createExportWrapper("lua_getinfo");

    Module["_luaL_pushresult"] = createExportWrapper("luaL_pushresult");

    Module["_luaL_addlstring"] = createExportWrapper("luaL_addlstring");

    Module["_luaL_argerror"] = createExportWrapper("luaL_argerror");

    Module["_luaL_where"] = createExportWrapper("luaL_where");

    Module["_luaL_typeerror"] = createExportWrapper("luaL_typeerror");

    Module["_luaL_getmetafield"] = createExportWrapper("luaL_getmetafield");

    Module["_luaL_fileresult"] = createExportWrapper("luaL_fileresult");

    var ___errno_location = createExportWrapper("__errno_location");

    Module["_luaL_execresult"] = createExportWrapper("luaL_execresult");

    Module["_luaL_newmetatable"] = createExportWrapper("luaL_newmetatable");

    Module["_luaL_setmetatable"] = createExportWrapper("luaL_setmetatable");

    Module["_luaL_testudata"] = createExportWrapper("luaL_testudata");

    Module["_luaL_checkudata"] = createExportWrapper("luaL_checkudata");

    Module["_luaL_optlstring"] = createExportWrapper("luaL_optlstring");

    Module["_luaL_checklstring"] = createExportWrapper("luaL_checklstring");

    Module["_luaL_checkstack"] = createExportWrapper("luaL_checkstack");

    Module["_luaL_checktype"] = createExportWrapper("luaL_checktype");

    Module["_luaL_checkany"] = createExportWrapper("luaL_checkany");

    Module["_luaL_checknumber"] = createExportWrapper("luaL_checknumber");

    Module["_luaL_optnumber"] = createExportWrapper("luaL_optnumber");

    Module["_luaL_checkinteger"] = createExportWrapper("luaL_checkinteger");

    Module["_luaL_optinteger"] = createExportWrapper("luaL_optinteger");

    Module["_luaL_pushresultsize"] = createExportWrapper("luaL_pushresultsize");

    Module["_luaL_buffinitsize"] = createExportWrapper("luaL_buffinitsize");

    Module["_luaL_ref"] = createExportWrapper("luaL_ref");

    Module["_luaL_unref"] = createExportWrapper("luaL_unref");

    Module["_luaL_loadfilex"] = createExportWrapper("luaL_loadfilex");

    Module["_luaL_loadbufferx"] = createExportWrapper("luaL_loadbufferx");

    Module["_luaL_loadstring"] = createExportWrapper("luaL_loadstring");

    Module["_luaL_callmeta"] = createExportWrapper("luaL_callmeta");

    Module["_luaL_len"] = createExportWrapper("luaL_len");

    Module["_luaL_tolstring"] = createExportWrapper("luaL_tolstring");

    Module["_luaL_setfuncs"] = createExportWrapper("luaL_setfuncs");

    Module["_luaL_getsubtable"] = createExportWrapper("luaL_getsubtable");

    Module["_luaL_requiref"] = createExportWrapper("luaL_requiref");

    Module["_luaL_addgsub"] = createExportWrapper("luaL_addgsub");

    Module["_luaL_gsub"] = createExportWrapper("luaL_gsub");

    Module["_luaL_newstate"] = createExportWrapper("luaL_newstate");

    Module["_lua_newstate"] = createExportWrapper("lua_newstate");
    ...
    Module["_luaL_checkversion_"] = createExportWrapper("luaL_checkversion_");

    Module["_luaopen_base"] = createExportWrapper("luaopen_base");

    Module["_luaopen_coroutine"] = createExportWrapper("luaopen_coroutine");

    Module["_lua_newthread"] = createExportWrapper("lua_newthread");

    Module["_lua_yieldk"] = createExportWrapper("lua_yieldk");

    Module["_lua_isyieldable"] = createExportWrapper("lua_isyieldable");

    Module["_lua_resetthread"] = createExportWrapper("lua_resetthread");

    Module["_lua_resume"] = createExportWrapper("lua_resume");

    Module["_luaopen_debug"] = createExportWrapper("luaopen_debug");

    Module["_lua_gethookmask"] = createExportWrapper("lua_gethookmask");

    Module["_lua_gethook"] = createExportWrapper("lua_gethook");

    Module["_lua_gethookcount"] = createExportWrapper("lua_gethookcount");

    Module["_lua_getlocal"] = createExportWrapper("lua_getlocal");

    Module["_lua_sethook"] = createExportWrapper("lua_sethook");

    Module["_lua_setlocal"] = createExportWrapper("lua_setlocal");

    Module["_lua_setcstacklimit"] = createExportWrapper("lua_setcstacklimit");

    var _malloc = Module["_malloc"] = createExportWrapper("malloc");

    Module["_luaL_openlibs"] = createExportWrapper("luaL_openlibs");

    Module["_luaopen_package"] = createExportWrapper("luaopen_package");

    Module["_luaopen_table"] = createExportWrapper("luaopen_table");

    Module["_luaopen_io"] = createExportWrapper("luaopen_io");

    Module["_luaopen_os"] = createExportWrapper("luaopen_os");

    Module["_luaopen_string"] = createExportWrapper("luaopen_string");

    Module["_luaopen_math"] = createExportWrapper("luaopen_math");

    Module["_luaopen_utf8"] = createExportWrapper("luaopen_utf8");

    Module["_lua_close"] = createExportWrapper("lua_close");
